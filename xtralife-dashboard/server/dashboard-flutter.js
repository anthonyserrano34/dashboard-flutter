...
app.get('/login', (req, res) => res.sendFile(path.resolve('client', 'build', 'web', 'index.html')));
app.get('/status', (req, res) => res.sendFile(path.resolve('client', 'build', 'web', 'index.html')));
app.get('/store', (req, res) => res.sendFile(path.resolve('client', 'build', 'web', 'index.html')));
app.get('/users', (req, res) => res.sendFile(path.resolve('client', 'build', 'web', 'index.html')));
app.get('/leaderboards', (req, res) => res.sendFile(path.resolve('client', 'build', 'web', 'index.html')));
app.get('/matches', (req, res) => res.sendFile(path.resolve('client', 'build', 'web', 'index.html')));
